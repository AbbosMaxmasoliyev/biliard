...
import BilyardniyStolCategory from "./pages/BilliardStol/AksessuarCategory";
import BilyardStolItem from "./pages/BilliardStol/Item";
...
const router = createBrowserRouter([
...

  {
    ...
    element: <BilyardStolItem />,
  },
  {
    path: "/billiardStol/:category",
    element: <BilyardniyStolCategory />,
  },
  {
    path: "/billiardStol",
