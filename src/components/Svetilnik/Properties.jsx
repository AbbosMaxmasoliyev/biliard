...
const PropertiesSvetilnik = ({ opisaniya, material, otziv }) => {
        ...
        >
          <div className="tab width772 ">
            ...
            <p>
              <br />
              <span className="h4">
                {material.name ? material.name : "Цвета выкраски"}
              </span>
            </p>
                  ...
                  <div key={index}>
                    <li className="selected">
                      ...
                      >
                        ...
                        {item.image && <img src={"/images/"+item.image} border="0" />}
                      </a>
                    </li>
                    ';
                  </div>
...
export default PropertiesSvetilnik;
