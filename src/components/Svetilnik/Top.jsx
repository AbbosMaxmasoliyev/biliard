...
const Top = () => {
  ...
  return (
    <div className="with-breadcrumbs">
      ...
      &nbsp; &nbsp;
      <h1 className="float-right width772"> Светильники для бильярда </h1>
      <br />
      <a
        style={{
          float: "right",
      ...
      <div className="main float-right width772 pos-relative center-right section_941">
        <span className="h2">NEO</span>
        <a
        ...
        <span className="label label-in-cues">Новинка</span>{" "}
        <a
      ...
      <div className="main float-right width772 pos-relative center-right section_745">
        <span className="h2">Evolution</span>
        <span className="label label-in-cues">Акция</span>{" "}
        <a
      ...
      <div className="main float-right width772 pos-relative center-right section_1041">
        <span className="h2">Лофт</span>
        <span className="label label-in-cues">Новинка</span>{" "}
        <a
      ...
      <div className="main float-right width772 pos-relative center-right section_449">
      ...
      <div className="main float-right width772 pos-relative center-right section_442">
        <span className="h2">Аристократ-Люкс</span>
      ...
      <div className="main float-right width772 pos-relative center-right section_443">
        <span className="h2">Аристократ</span>
        <span className="label label-in-cues">Акция</span>{" "}
        <a
      ...
      <div className="main float-right width772 pos-relative center-right section_444">
        <span className="h2">Классика</span>
      ...
      <div className="main float-right width772 pos-relative center-right section_766">
        <span className="h2">Эксклюзивные светильники</span>
        <span className="label label-in-cues">Акция</span>{" "}
        <a
      ...
      <div className="main float-right width772 pos-relative center-right section_753">
        <span className="h2">Декоративное освещение</span>

        <br />
        <br />
      </div>
      <div className="main float-right width772 pos-relative center-right section_1067">
        <span className="h2">Бра</span>
      ...
      <div className="main float-right width772 pos-relative center-right section_1069">
        <span className="h2">Настольные светильники</span>
      ...
      <div className="main float-right width772 pos-relative center-right section_1068">
        <span className="h2">Торшеры</span>
      ...
      <div className="main float-right width772 pos-relative center-right section_1044">
        <span className="h2">Для столов 6 футов</span>
        <a
      ...
      <div className="main float-right width772 pos-relative center-right section_1045">
        <span className="h2"> Для столов 7 футов</span>
        <a
      ...
      <div className="main float-right width772 pos-relative center-right section_1046">
        <span className="h2">Для столов 8 футов</span>
        <a
      ...
      <div className="main float-right width772 pos-relative center-right section_1047">
        <span className="h2">Для столов 9 футов</span>
        <a
      ...
      <div className="main float-right width772 pos-relative center-right section_1048">
        <span className="h2">Для столов 10 футов</span>
        <a
      ...
      <div className="main float-right width772 pos-relative center-right section_1049">
        <span className="h2">Для столов 11 футов</span>
        <a
      ...
      <div className="main float-right width772 pos-relative center-right section_1050">
        <span className="h2">Для столов 12 футов</span>
        <a
