...
const TennisniyStolCategoryComponent = () => {
      ...
      <div className="with-breadcrumbs">
        <div className="bx-breadcrumb">
          ...
          >
            <i className="fa fa-angle-right"></i>
            <a
              href="https://www.fabrika-start.ru/catalog/sect/836/"
              title="Теннисные столы"
              itemprop="url"
            >
              <span itemprop="title">Теннисные столы</span>
            </a>
          </div>
          <div
            className="bx-breadcrumb-item"
          ...
          >
            <i className="fa fa-angle-right"></i>
            <a
              href="https://www.fabrika-start.ru/catalog/sect/1016/"
              title="Любительские"
              itemprop="url"
            >
              <span itemprop="title">Любительские</span>
            </a>
          </div>
          <div className="bx-breadcrumb-item">
            <i className="fa fa-angle-right"></i>
            <span>Junior blue</span>
          </div>
          <div style={{ clear: "both" }}></div>
        </div>
        &nbsp; &nbsp;
        <h1 className="float-right width772">
          Теннисный стол {keyLinksJson[params.category]?.name}
        </h1>
        <br />
        <a
          style={{
            ...
            {links?.map((item, index) => {
              ...
              return (
                <li key={index}>
                  <div>
                    <Link
                      to={`/tennisniyStol/${params.category}/${item}`}
                      title={name}
                    >
                      <img
                        src={"/images/" + (images[0] ? images[0] : image[0])}
                        className="w178"
                      />
                    </Link>
                  </div>
...
export default TennisniyStolCategoryComponent;
