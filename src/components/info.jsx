...
const Info = () => {
    ...
    return (
        ...
        <div className="wrap-content-center">
            <div className="main">
                <div className="js__text-spoiler corr__text-spoiler" data-open="false">
                    <div className="js__text-spoiler-intro">
                    ...
                    {active ? <div className="js__text-spoiler-text" style={{ display: "block" }}>
                        <p>
                        </p>
